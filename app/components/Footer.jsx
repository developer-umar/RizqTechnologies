...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/profile.php?id=61589274352434",
      label: "Like",
      icon: (
    ...
    {
      name: "GitHub",
      href: "https://github.com/rizqtechnologies",
      label: "Code",
      icon: (
          ...
          <div className="sm:col-span-2 md:col-span-4">
            ...
            <div className="space-y-3 lg:space-y-4">
              <div className="flex items-center gap-3 text-gray-300 group cursor-pointer">
                ...
                <span className="text-xs lg:text-sm break-all">info@rizqtechnologies.online</span>
              </div>
            </div>
          </div>
