            ...
            <nav className={`max-w-7xl mx-auto transition-all duration-500 border rounded-[2rem] px-6 md:px-10 flex justify-between items-center h-[70px] md:h-[80px] ${scrolled
                ...
                <div className="hidden md:flex items-center gap-8 lg:gap-12">
                    ...
                    <Link href="#contact">
                        <motion.button
                            whileTap={{ scale: 0.92 }}
                            className="relative overflow-hidden group bg-yellow-400 text-black px-8 py-3 rounded-full font-black text-xs uppercase tracking-wider transition-all duration-300"
                        >
                            ...
                            <span className="absolute inset-0 rounded-full shadow-[0_0_0px_rgba(250,204,21,0.7)] group-hover:shadow-[0_0_30px_rgba(250,204,21,0.8)] transition-all duration-500"></span>

                            {/* 🔥 Inner glow ring */}
                            <span className="absolute inset-0 rounded-full border border-yellow-300/40 group-hover:border-yellow-200 transition-all duration-300"></span>

                            {/* 🔥 Text + Arrow animation */}
