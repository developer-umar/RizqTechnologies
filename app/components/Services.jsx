...
const SERVICES = [
  ...
  { num: "07", name: "Custom Software", desc: "Tailored software built exactly for your business unique architectural problems.", features: ["ERP Systems", "Legacy Migrations", "Security Audits", "Database Design"], img: "/services/software.jfif", span: "md:col-span-12", icon: <Monitor size={18} />, details: "Custom software from ERP systems to API integrations. Designed for scalability, security, and long-term maintainability — built to your exact business requirements." },
];
