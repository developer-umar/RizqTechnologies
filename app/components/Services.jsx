...
const SERVICES = [
  ...
  { num: "06", name: "App Development", desc: "Seamless mobile apps designed for engagement & performance.", features: ["iOS/Android", "React Native", "Smooth UX", "Store Ready"], img: "/services/mobile.png", span: "md:col-span-6", icon: <Smartphone size={18} />, details: "Cross-platform mobile apps using React Native delivering native-quality performance on iOS and Android. From concept to App Store submission, we handle the entire lifecycle." },
  { num: "07", name: "Custom Software", desc: "Tailored software built exactly for your business unique architectural problems.", features: ["ERP Systems", "Legacy Migrations", "Security Audits", "Database Design"], img: "/services/software.png", span: "md:col-span-12", icon: <Monitor size={18} />, details: "Custom software from ERP systems to API integrations. Designed for scalability, security, and long-term maintainability — built to your exact business requirements." },
];
